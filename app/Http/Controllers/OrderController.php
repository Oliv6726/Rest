...
class OrderController extends Controller
{
    ...
    public function get(string $name){
        ...
        if(!strpos($category->category_items, ',')) {
            $item_name = Products::select('product_name', 'product_desc')->where('product_id', $category->category_items)->first();
            $category->category_items = $item_name->product_name;
            ...
            $category->category_items = $this->parse_items($items);
            return dd($category);
        }
    ...
    public function jsonEncode(string $array){
